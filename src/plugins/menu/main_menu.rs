            ...
            parent
                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/Game Icons/play.png");
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/Game Icons/gear.png");
                            parent.spawn(ImageBundle {
                                style: button_icon_style.clone(),
                                image: UiImage::new(icon),
                                ..default()
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            let icon = asset_server.load("textures/Game Icons/exit.png");
                            parent.spawn(ImageBundle {
